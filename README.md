...
| 源 | 用途 | 合规性 |
|----|------|--------|
| **Apple Marketing Tools RSS v2** | 榜单排名（`top-free` / `top-paid`，各国，每日更新，上限 100） | 官方公开、免鉴权、完全合规 |
| **iTunes Lookup API** | 按 app id 富化品类 / 评分 / 价格 / 开发者 / 版本 | 官方公开、免鉴权 |
...
- **M2** 细分品类深度：接入分品类榜数据源（旧版 genre RSS 兜底 / 付费 API 可插拔），补足解谜等小众品类覆盖。
